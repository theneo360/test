...
<div class = "text-center mt-5" >
    ...
    <?php echo csrf_field(); ?>
       ...
       <!-- <?php echo e($errors); ?>  -->
        ...
        <div class="mt-3">
            <button class="btn btn-lg btn-success btn-block" type="submit">Sign ip</button>
        </div>
    </form>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/neo/resources/views/signup.blade.php ENDPATH**/ ?>